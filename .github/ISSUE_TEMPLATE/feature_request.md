...
about: Suggest a new protocol, detection, or improvement
title: "[FEAT] "
labels: enhancement
assignees: ''
---
...
- CVE or advisory (if relevant)

## Example Evidence
What would the traffic or finding look like? (No real PHI please)

```
example packet / payload / finding output
```
